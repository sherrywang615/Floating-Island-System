...
public:
    ...
    DensityField Generate_Density_Field_From_Mesh(float spacing);
    void Generate_Mesh_From_Density_Field(const DensityField& d, float iso_value, vec3 field_start);
