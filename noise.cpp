...
namespace
{
    ...
    static PermutationInitializer permutationInitializer;
    ...
    float perlin3D_single(float x, float y, float z)
    {
...
namespace noise
{
                       ...
                       float gain)
    {
        ...
        {
            sum  += perlin3D_single(x * frequency, y * frequency, z * frequency) * amplitude;
            norm += amplitude;
